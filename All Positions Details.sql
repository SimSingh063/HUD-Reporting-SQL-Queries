/* 
 Title - All Position Details (HR Version)
 Author - Simranjeet Singh
 Date - 26/05/2023
 Description - Details of all occupied, vacant and positions in active recritment within the organisation.  
 */
WITH Position AS (
	SELECT
		Pos.Position_Code,
